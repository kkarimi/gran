...
6. GitHub Actions then creates the matching GitHub Release with generated notes, package metadata,
   commit highlights, a committed changelog entry, and standalone release archives.
