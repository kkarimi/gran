---
title: Releases
description: Track shipped versions, changelog entries, installable artefacts, and GitHub Releases for Gran.
---
...
- a committed changelog entry in [`CHANGELOG.md`](https://github.com/kkarimi/gran/blob/main/CHANGELOG.md)

## Where To Look

- [GitHub Releases](https://github.com/kkarimi/gran/releases)
- [CHANGELOG.md](https://github.com/kkarimi/gran/blob/main/CHANGELOG.md)
- [npm package history](https://www.npmjs.com/package/@kkarimi/gran?activeTab=versions)
