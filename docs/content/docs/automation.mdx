...
Inspect generated artefacts and replay a pipeline:
...
- CLI: inspect rules, matches, runs, and generated artefacts, and replay pipelines or resolve pending `ask-user` runs
- Web: browse recent automation runs; artefact review lands in the next review-workspace slice
- TUI: open the automation overlay with `u`; artefact review lands in the next review-workspace slice
