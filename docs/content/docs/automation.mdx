...
- CLI: inspect rules, matches, runs, and generated artefacts, replay pipelines, resolve pending `ask-user` runs, and approve or reject generated artefacts
- Web: browse recent automation runs, review generated artefacts against the current meeting notes, edit them inline, and approve, reject, or rerun them
- TUI: open the automation review overlay with `u` to approve, reject, or rerun generated artefacts and pending `ask-user` runs
