...
Gran's primary job is to be the local Granola workspace and source runtime.

This page is for the advanced local automation layer inside Gran itself. If you want a broader
...
and let Yazd own those knowledge-base plugins instead of teaching Gran every remote publish API.
