...
This is the preferred advanced extension path for external tools, including future Yazd workflows.
...
When you use `--format json` or `--format yaml`, Gran now keeps stdout clean and skips the human
