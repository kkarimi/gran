...
For API-backed destinations like Notion, Capacities, or Tana, keep Gran as the source-side SDK and
let Yazd own the actual knowledge-base plugin and remote publish flow.
