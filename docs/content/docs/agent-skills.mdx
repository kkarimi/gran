---
title: Agent Skills
description: Reuse granola-toolkit from external agents, including the built-in OpenClaw skill directory shipped in this repo.
---
...
```text
skills/openclaw-granola-toolkit
```
...
assumes the toolkit is installed as either `granola` or `granola-toolkit`.
...
```text
skills/openclaw-granola-toolkit/references/cli-examples.md
```
