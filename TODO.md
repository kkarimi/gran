...
| P2       | In Progress | M    |              | Web / Component Domain Split             | Split `components.tsx` into meeting, review, settings, and home/search component groups.                                                | The component surface is still one warehouse file, which hides page boundaries.                 |
