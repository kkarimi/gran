...
| P2       | Done        | S    |              | UX / Onboarding        | End first-run onboarding after connect + import, with automation as a secondary next step.                                          | Users should reach value before they have to choose an agent.        |
| P2       | Done        | M    |              | UX / TUI               | Simplify TUI browsing so folders, recent items, and meetings do not compete in one pane.                                            | The TUI currently asks users to parse too many browse modes at once. |
