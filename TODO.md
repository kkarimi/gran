...
Previous completed roadmap: `V1-LAUNCH-TODO.md`.
...
| -------- | ------- | ---- | ------------ | --------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| P1       | Pending | L    |              | Architecture / Core Service Split | Split `GranolaApp` into composed services for auth/session, sync, catalog, automation, and exports while keeping one top-level app API. | The current core is a god object and makes every new feature pay a coupling tax.             |
